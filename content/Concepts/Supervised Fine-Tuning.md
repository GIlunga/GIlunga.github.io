...
In the context of [[LLM | LLMs]], SFT is typically used as the first step in the alignment process, teaching the model to follow instructions and respond appropriately to user queries.